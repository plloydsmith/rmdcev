...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(162, 22, "include", "/common/mdcev_tdata.stan");
    reader.add_event(162, 0, "start", "/common/mdcev_tdata.stan");
    reader.add_event(209, 47, "end", "/common/mdcev_tdata.stan");
    reader.add_event(209, 23, "restart", "model_mdcev");
    reader.add_event(337, 149, "end", "model_mdcev");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "single_scale", "int", context__.to_vec());
            single_scale = int(0);
            vals_i__ = context__.vals_i("single_scale");
            pos__ = 0;
            single_scale = vals_i__[pos__++];
            ...
            if (as_bool(logical_eq(fixed_scale1, 0))) {
                current_statement_begin__ = 206;
                stan::math::assign(S, 1);
            } else if (as_bool(logical_eq(fixed_scale1, 1))) {
                current_statement_begin__ = 208;
                stan::math::assign(S, 0);
            }
            current_statement_begin__ = 211;
            if (as_bool((primitive_value(logical_eq(single_scale, 0)) && primitive_value(logical_eq(fixed_scale1, 0))))) {
                current_statement_begin__ = 212;
                stan::math::assign(S, K);
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("scale", "S", S);
        context__.validate_dims("parameter initialization", "scale", "vector_d", context__.to_vec(S));
        Eigen::Matrix<double, Eigen::Dynamic, 1> scale(S);
        size_t scale_j_1_max__ = S;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                scale = in__.vector_lb_constrain(0, S, lp__);
            else
                scale = in__.vector_lb_constrain(0, S);
            current_statement_begin__ = 221;
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                if (as_bool(logical_eq(S, 1))) {
                    ...
                    stan::math::assign(scale_full, get_base1(scale, 1, "scale", 1));
                } else if (as_bool(logical_eq(S, K))) {
                    current_statement_begin__ = 238;
                    stan::math::assign(scale_full, get_base1(scale, k, "scale", 1));
                } else {
                    current_statement_begin__ = 240;
                    stan::math::assign(scale_full, 1.0);
                }
            ...
            if (as_bool(logical_gt(K, 1))) {
                ...
                for (int i = 1; i <= I; ++i) {
                    ...
                    stan::math::assign(ltheta,log_softmax(append_row(0, multiply(delta, transpose(get_base1(data_class, i, "data_class", 1))))));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> scale = in__.vector_lb_constrain(0, S);
        size_t scale_j_1_max__ = S;
        for (size_t j_1__ = 0; j_1__ < scale_j_1_max__; ++j_1__) {
