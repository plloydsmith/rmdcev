...
namespace user_cfe4c50c75ea7513e1fc490c61ccdd93 { 
using std::istream;
using std::string;
...
struct DrawError_rng_functor__ {
    ...
    operator()(const T0__& quant_num,
                  ...
                  const int& cond_error,
                  const int& draw_mlhs, RNG& base_rng__, std::ostream* pstream__) const {
        return DrawError_rng(quant_num, quant_j, price_j, psi_j, gamma_j, alpha, scale, nalts, nerrs, cond_error, draw_mlhs, base_rng__, pstream__);
    }
};
...
struct ComputeUtilJ_functor__ {
    ...
    operator()(const T0__& income,
        ...
        return ComputeUtilJ(income, quant_j, price_j, psi_j, gamma_j, alpha, nalts, model_num, pstream__);
    }
};
...
CalcWTP_rng(const T0__& income,
    ...
    try {
        ...
        for (int sim = 1; sim <= nsims; ++sim) {
            ...
            stan::math::assign(error, DrawError_rng(quant_num, quant_j, stan::model::rvalue(price, stan::model::cons_list(stan::model::index_min_max(2, (nalts + 1)), stan::model::nil_index_list()), "price"), psi_j, stan::model::rvalue(gamma, stan::model::cons_list(stan::model::index_min_max(2, (nalts + 1)), stan::model::nil_index_list()), "gamma"), alpha, scale, nalts, nerrs, cond_error, draw_mlhs, base_rng__, pstream__));
...
Shuffle_rng(const Eigen::Matrix<double, 1, Eigen::Dynamic>& inv,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::Shuffle_rng<double, boost::ecuyer1988>(inv, nerrs, base_rng__, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, 1, Eigen::Dynamic>
DrawMlhs_rng(const int& nerrs,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::DrawMlhs_rng<boost::ecuyer1988>(nerrs, draw_mlhs, base_rng__, pstream__);
}
// [[Rcpp::export]]
...
DrawError_rng(const double& quant_num,
                  ...
                  const int& draw_mlhs, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::DrawError_rng<double, double, double, double, double, double, double, boost::ecuyer1988>(quant_num, quant_j, price_j, psi_j, gamma_j, alpha, scale, nalts, nerrs, cond_error, draw_mlhs, base_rng__, pstream__);
}
// [[Rcpp::export]]
std::vector<int>
CalcAltOrder(const Eigen::Matrix<double, Eigen::Dynamic, 1>& MUzero,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::CalcAltOrder<double>(MUzero, nalts, pstream__);
}
// [[Rcpp::export]]
...
SortParmMatrix(const Eigen::Matrix<double, Eigen::Dynamic, 1>& MUzero,
                   ...
                   const int& nalts, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::SortParmMatrix<double, double, double, double>(MUzero, price, gamma, alpha, nalts, pstream__);
}
// [[Rcpp::export]]
double
ComputeE(const int& M,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::ComputeE<double, double, double, double, double>(M, lambda, g_price, b, c, d, pstream__);
}
// [[Rcpp::export]]
...
MarshallianDemand(const double& income,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::MarshallianDemand<double, double, double, double, double, double>(income, price, MUzero, gamma, alpha, nalts, algo_gen, tol_e, max_loop, pstream__);
}
// [[Rcpp::export]]
double
ComputeUtilJ(const double& income,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::ComputeUtilJ<double, double, double, double, double, double>(income, quant_j, price_j, psi_j, gamma_j, alpha, nalts, model_num, pstream__);
}
// [[Rcpp::export]]
double
ComputeUtilM(const int& M,
                 ...
                 const int& model_num, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::ComputeUtilM<double, double, double, double, double, double, double, double>(M, lambda1, g_psi_a, a_a_1, mu_a_a_1, psi, g, price, d, model_num, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
HicksianDemand(const double& util,
                   ...
                   const int& max_loop, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::HicksianDemand<double, double, double, double, double, double>(util, price, MUzero, gamma, alpha, nalts, algo_gen, model_num, tol_l, max_loop, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
CalcmdemandOne_rng(const double& income,
  ...
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::CalcmdemandOne_rng<double, double, double, double, double, double, double, boost::ecuyer1988>(income, price, psi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, algo_gen, tol, max_loop, base_rng__, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
CalcWTP_rng(const double& income,
                ...
                const int& max_loop, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::CalcWTP_rng<double, double, double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, quant_j, price, price_p_policy, psi_p_sims, psi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, cond_error, draw_mlhs, algo_gen, model_num, tol, max_loop, base_rng__, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
CalcWTPPriceOnly_rng(const double& income,
                         ...
                         const int& max_loop, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::CalcWTPPriceOnly_rng<double, double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, quant_j, price, price_p_policy, psi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, cond_error, draw_mlhs, algo_gen, model_num, tol, max_loop, base_rng__, pstream__);
}
// [[Rcpp::export]]
...
CalcMarshallianDemand_rng(const double& income,
                              ...
                              const int& max_loop, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::CalcMarshallianDemand_rng<double, double, double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, quant_j, price, price_p_policy, psi_p_sims, psi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, cond_error, draw_mlhs, algo_gen, model_num, tol, max_loop, base_rng__, pstream__);
}
// [[Rcpp::export]]
std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >
CalcMarshallianDemandPriceOnly_rng(const double& income,
                                       ...
                                       const int& max_loop, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_cfe4c50c75ea7513e1fc490c61ccdd93::CalcMarshallianDemandPriceOnly_rng<double, double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, quant_j, price, price_p_policy, psi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, cond_error, draw_mlhs, algo_gen, model_num, tol, max_loop, base_rng__, pstream__);
}
