...
namespace user_fa4690bb80fca7eb0db2af0c25b362e8 { 
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(698, 696, "end", "unknown file name");
    return reader;
}
...
ComputeKtUtilM(const int& M,
    ...
    try {
        ...
        stan::model::assign(temp, 
                    stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                    ((get_base1(psi, 1, "psi", 1) * pow(lambda1, (alpha_1 / (alpha_1 - 1)))) / alpha_1), 
                    "assigning variable temp");
    ...
    try {
        ...
        if (as_bool(logical_eq(algo_gen, 0))) {
            ...
            if (as_bool(logical_lt(model_num, 5))) {
                ...
                stan::math::assign(g_psi_a, elt_divide(elt_multiply(g, psi_ord), a));
            ...
            while (as_bool(logical_eq(exit, 0))) {
                ...
                if (as_bool(logical_lt(model_num, 5))) {
                    ...
                    stan::math::assign(util_new, ComputeUtilM(M, lambda1, g_psi_a, a_a_1, mu_a_a_1, psi_ord, g, price_ord, d, model_num, pstream__));
                } else if (as_bool(logical_eq(model_num, 5))) {
                ...
                if (as_bool((primitive_value(logical_gte(util_new, util)) || primitive_value(logical_eq((M + 1), (nalts + 1)))))) {
                    ...
                    if (as_bool(logical_lt(model_num, 5))) {
                        ...
                        stan::model::assign(X, 
                                    stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                    pow((lambda1 / get_base1(mu, 1, "mu", 1)), inv((alpha_1 - 1))), 
                                    "assigning variable X");
...
Shuffle_rng(const Eigen::Matrix<double, Eigen::Dynamic, 1>& inv_temp,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::Shuffle_rng<double, boost::ecuyer1988>(inv_temp, nerrs, base_rng__, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
DrawMlhs_rng(const int& nerrs,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::DrawMlhs_rng<boost::ecuyer1988>(nerrs, draw_mlhs, base_rng__, pstream__);
}
// [[Rcpp::export]]
...
DrawError_rng(const double& quant_num,
                  ...
                  const int& draw_mlhs, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::DrawError_rng<double, double, double, double, double, double, double, double, boost::ecuyer1988>(quant_num, quant_j, price_j, psi_j, phi_j, gamma_j, alpha, scale, model_num, nalts, nerrs, cond_error, draw_mlhs, base_rng__, pstream__);
}
// [[Rcpp::export]]
std::vector<int>
CalcAltOrder(const Eigen::Matrix<double, Eigen::Dynamic, 1>& MUzero,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::CalcAltOrder<double>(MUzero, nalts, pstream__);
}
// [[Rcpp::export]]
...
SortParmMatrix(const Eigen::Matrix<double, Eigen::Dynamic, 1>& MUzero,
                   ...
                   const int& nalts, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::SortParmMatrix<double, double, double, double>(MUzero, price, gamma, alpha_phi, nalts, pstream__);
}
// [[Rcpp::export]]
double
ComputeE(const int& M,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::ComputeE<double, double, double, double, double>(M, lambda, g_price, b, c, d, pstream__);
}
// [[Rcpp::export]]
double
ComputeKtE(const int& M,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::ComputeKtE<double, double, double, double>(M, lambda, mu, g_price__phi, alpha_1, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
MarshallianDemand(const double& income,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::MarshallianDemand<double, double, double, double, double, double, double>(income, price, MUzero, phi, gamma, alpha, nalts, algo_gen, model_num, tol_e, max_loop, pstream__);
}
// [[Rcpp::export]]
double
ComputeUtilJ(const double& income,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::ComputeUtilJ<double, double, double, double, double, double, double>(income, quant_j, price_j, psi, phi_j, gamma_j, alpha, nalts, model_num, pstream__);
}
// [[Rcpp::export]]
double
ComputeUtilM(const int& M,
                 ...
                 const int& model_num, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::ComputeUtilM<double, double, double, double, double, double, double, double>(M, lambda1, g_psi_a, a_a_1, mu_a_a_1, psi, g, price, d, model_num, pstream__);
}
// [[Rcpp::export]]
double
ComputeKtUtilM(const int& M,
                   ...
                   const double& alpha_1, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::ComputeKtUtilM<double, double, double, double>(M, lambda1, psi, mu, alpha_1, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
HicksianDemand(const double& util,
                   ...
                   const int& max_loop, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::HicksianDemand<double, double, double, double, double, double, double>(util, price, MUzero, phi, gamma, alpha, nalts, algo_gen, model_num, tol_l, max_loop, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
CalcWTP_rng(const double& income,
  ...
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::CalcWTP_rng<double, double, double, double, double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, quant_j, price, price_p_policy, psi_p_sims, phi_p_sims, psi_sims, phi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, cond_error, draw_mlhs, algo_gen, model_num, price_change_only, tol, max_loop, base_rng__, pstream__);
}
// [[Rcpp::export]]
...
CalcMarshallianDemand_rng(const double& income,
                              ...
                              const int& max_loop, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::CalcMarshallianDemand_rng<double, double, double, double, double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, quant_j, price, price_p_policy, psi_p_sims, phi_p_sims, psi_sims, phi_sims, gamma_sims, alpha_sims, scale_sims, nerrs, cond_error, draw_mlhs, algo_gen, model_num, price_change_only, tol, max_loop, base_rng__, pstream__);
}
// [[Rcpp::export]]
Eigen::Matrix<double, Eigen::Dynamic, 1>
CalcmdemandOne_rng(const double& income,
                       ...
                       const int& max_loop, boost::ecuyer1988& base_rng__, std::ostream* pstream__ = 0){
  return 
user_fa4690bb80fca7eb0db2af0c25b362e8::CalcmdemandOne_rng<double, double, double, double, double, double, double, double, boost::ecuyer1988>(income, price, psi_j, phi_j, gamma_j, alpha, scale, nerrs, model_num, algo_gen, tol, max_loop, base_rng__, pstream__);
}
