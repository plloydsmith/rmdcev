...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(90, 87, "end", "/common/mdcev_ll.stan");
    reader.add_event(90, 4, "restart", "model_mdcev");
    reader.add_event(96, 10, "include", "/common/mdcev_data.stan");
    reader.add_event(96, 0, "start", "/common/mdcev_data.stan");
    reader.add_event(115, 19, "end", "/common/mdcev_data.stan");
    reader.add_event(115, 11, "restart", "model_mdcev");
    ...
    reader.add_event(159, 21, "restart", "model_mdcev");
    reader.add_event(244, 104, "end", "model_mdcev");
    return reader;
}
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(K,1))) {
                ...
                stan::math::assign(log_like, mdcev_ll(j_quant,quant_full,log_price,log_num,price_full,log_inc,dat_psi,M,M_factorial,weights,lpsi,gamma_full,alpha_full,scale_full,I,J,G,ones_g,nonzero,model_num,fixed_scale,trunc_data, pstream__));
                }
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    stan::model::assign(log_like_util, 
                                ...
                                mdcev_ll(j_quant,quant_full,log_price,log_num,price_full,log_inc,dat_psi,M,M_factorial,weights,lpsi,gamma_full,alpha_full,scale_full,I,J,G,ones_g,nonzero,model_num,fixed_scale,trunc_data, pstream__), 
