...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(118, 116, "end", "/common/mdcev_ll.stan");
    reader.add_event(118, 3, "restart", "model_mdcev_rp");
    reader.add_event(122, 7, "include", "/common/mdcev_data.stan");
    reader.add_event(122, 0, "start", "/common/mdcev_data.stan");
    reader.add_event(145, 23, "end", "/common/mdcev_data.stan");
    reader.add_event(145, 8, "restart", "model_mdcev_rp");
    reader.add_event(160, 23, "include", "/common/mdcev_tdata.stan");
    reader.add_event(160, 0, "start", "/common/mdcev_tdata.stan");
    reader.add_event(200, 40, "end", "/common/mdcev_tdata.stan");
    reader.add_event(200, 24, "restart", "model_mdcev_rp");
    reader.add_event(335, 157, "end", "model_mdcev_rp");
    return reader;
}
