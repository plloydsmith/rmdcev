...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(117, 115, "end", "/common/mdcev_ll.stan");
    reader.add_event(117, 3, "restart", "model_mdcev_rp");
    reader.add_event(121, 7, "include", "/common/mdcev_data.stan");
    reader.add_event(121, 0, "start", "/common/mdcev_data.stan");
    reader.add_event(144, 23, "end", "/common/mdcev_data.stan");
    reader.add_event(144, 8, "restart", "model_mdcev_rp");
    reader.add_event(159, 23, "include", "/common/mdcev_tdata.stan");
    reader.add_event(159, 0, "start", "/common/mdcev_tdata.stan");
    reader.add_event(199, 40, "end", "/common/mdcev_tdata.stan");
    reader.add_event(199, 24, "restart", "model_mdcev_rp");
    reader.add_event(334, 157, "end", "model_mdcev_rp");
    return reader;
}
