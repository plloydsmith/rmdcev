...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(938, 936, "end", "model_SimulationFunctions");
    return reader;
}
...
template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__, typename T6__, typename T9__, class RNG>
...
CalcmdemandOne_rng(const T0__& income,
    ...
    try {
        ...
        stan::math::assign(nalts,(cols(price) - 1));
...
struct CalcmdemandOne_rng_functor__ {
    ...
    operator()(const T0__& income,
        ...
        return CalcmdemandOne_rng(income, price, psi_j, phi, gamma_j, alpha, scale, nerrs, algo_gen, tol, max_loop, base_rng__, pstream__);
    }
};
...
class model_SimulationFunctions
  : public stan::model::model_base_crtp<model_SimulationFunctions> {
private:
public:
