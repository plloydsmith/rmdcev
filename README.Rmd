...
3. Random parameters models (Bayesian estimation, except KT model specifications)
...
As an example, we can simulate some data using Bhat (2008)'s 'Gamma' specification. In this example, we are simulating data for 2,000 individuals and 10 non-numeraire alternatives. 
